...
export class AppComponent {
  ...
  dataRenderingHandle(event: any, ui: any) {
    console.log(event);
    console.log(ui);
    console.log(event.ui.owner.options.columns);
  ...
  public loadData() {
    ...
    this.gridObject.results.push({
      RecordId: ++this.rowId,
      RecordName: 'test ' + this.rowId, RecordDescription: 'test description', Fragments: 1, Link: null, Type: null
    });
    this.gridObject.results.push({
      RecordId: ++this.rowId,
      RecordName: 'test ' + this.rowId, RecordDescription: 'test description', Fragments: 1, Link: null, Type: null
  ...
  public initGridData() {
    ...
    this.gridObject.results.push({
      RecordId: ++this.rowId,
      RecordName: 'test ' + this.rowId,
      RecordDescription: 'test description', Fragments: 1, Link: null, Type: null
    });


    this.gridOptions = {
      dataSource: this.gridObject.results,
      width: '100%',
      height: '400px',
